...
Run against the shipped v10 head + the corpus it was trained on:
    ...
    python -m bench.permute_match_features \
        --ckpt bench/data/phase3_v10_face.pt \
        --val  bench/data/pairs_val.npz
...
def main():
    ...
    p.add_argument("--ckpt", default="bench/data/phase3_v10_face.pt")
    p.add_argument("--val",  default="bench/data/pairs_val.npz")
