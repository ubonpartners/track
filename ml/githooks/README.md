...
Activate with:
    ...
    git config --local core.hooksPath ml/githooks
...
Runs `python ml/util/verify_tree_sentinels.py` when the staged set touches
...
(...and update `ml/util/verify_tree_sentinels.py` to reflect the new
