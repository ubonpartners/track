...
ROOT = Path(__file__).resolve().parent.parent.parent  # ml/util/file.py → track/
...
PY_SENTINELS = [
    ...
    (
        "ml/data_prep/build_state_corpus.py",
    ...
    (
        "ml/train/train_state_head_decoupled.py",
