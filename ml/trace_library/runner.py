...
Loads every `.npz` under `ml/trace_library/traces/`, runs the head
...
from ml.train.train_state_head_decoupled import DecoupledGRUHead
from ml.eval.eval_decoupled_offline import cost_decision, UNCONFIRMED, TRACKED, LOST
...
def main():
    ...
    ap.add_argument("--trace-dir", default="ml/trace_library/traces",
