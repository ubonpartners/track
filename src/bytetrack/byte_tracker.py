...
from src.bytetrack.kalman_filter import KalmanFilter
import src.bytetrack.matching as matching
from src.bytetrack.basetrack import BaseTrack, TrackState
...
class BYTETracker(object):
    ...
    def update(self, bboxes, scores, time):
        ...
        matches, u_track, u_detection = matching.linear_assignment(dists, thresh=self.args["match_thresh1"])
        ...
        self.tracked_stracks, self.lost_stracks = remove_duplicate_stracks(self.tracked_stracks, self.lost_stracks, self.args["match_remove_dup"])
...
def remove_duplicate_stracks(stracksa, stracksb, thr):
